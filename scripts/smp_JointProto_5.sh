...
lr_lst=(0.00001 0.00005 0.00002)
                                    ...
                                    do
                                        ...
                                        do
                                            ...
                                            do
                                                ...
                                                do
                                                    # model names
                                                    model_name=JointProto.${task}.ga_${grad_acc}.bs_${train_batch_size}.ep_${epoch}.lr_${lr}.up_lr_${upper_lr}.dec_${decoder}${label_wp}${use_schema}${do_debug}

                                                ...
                                                do
                                                    ...
                                                    do
                                                        ...
                                                        do
                                                            ...
                                                            do
                                                                # model names
                                                                model_name=LD-Proto+TR.ls_${loss_scale_type}.${slu_model_type}.sp_${split_metric}_dim_${metric_dim}_act_${metric_activation}.${task}.ga_${grad_acc}.bs_${train_batch_size}.dec_${decoder}${use_schema}${do_debug}

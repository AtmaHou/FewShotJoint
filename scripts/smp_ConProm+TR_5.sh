		                                                                    ...
		                                                                    do
							                                                    ...
							                                                    do
							                                                        ...
							                                                        do
								                                                        ...
								                                                        do
					                                                                        # model names
					                                                                        model_name=ConProm+TR.${decoder}.pm_rg_${slu_regular}_r_${slu_regular_rate}_m_${margin}${with_homo}.sp_${split_metric}_${metric_activation}_${metric_dim}.${slu_model_type}.${proto_merge_type}.update_${proto_update}${pm_use_attn}${pm_rpl}.ep_${epoch}.pr_nm_${pr_nm}.scl_${pr_scl}.scl_r_${proto_scale_r}.${task}.ga_${grad_acc}.bs_${train_batch_size}.dec_${decoder}${use_schema}${do_debug}

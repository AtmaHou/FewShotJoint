...
proto_merge_type_lst=(merge_both)
pm_rpl=
pm_use_attn=-pm_ua

split_metric_lst=(both)
#split_metric_lst=(both intent slot)
metric_activation_lst=(none)
metric_dim=768

#proto_update_lst=(slu intent slot)
proto_update_lst=(slu)
		                                                                    ...
		                                                                    do
							                                                    ...
							                                                    do
							                                                        ...
							                                                        do
								                                                        ...
								                                                        do
					                                                                        # model names
					                                                                        model_name=ConProm.${decoder}.pm_rg_${slu_regular}_r_${slu_regular_rate}_m_${margin}${with_homo}.sp_${split_metric}_${metric_activation}_${metric_dim}.${slu_model_type}.${proto_merge_type}.update_${proto_update}${pm_use_attn}${pm_rpl}.ep_${epoch}.pr_nm_${pr_nm}.scl_${pr_scl}.scl_r_${proto_scale_r}.${task}.ga_${grad_acc}.bs_${train_batch_size}.dec_${decoder}${use_schema}${do_debug}
					                                                                        ...
					                                                                        CUDA_VISIBLE_DEVICES=${gpu_list} python main.py ${do_debug} \
					                                                                            ...
					                                                                            --decoder ${decoder} \
					                                                                            --transition learn \
																								--save_feature > ./result/ConPromOld/${model_name}.DATA.${file_mark}.log
					                                                                        echo [CLI]
					                                                                        echo Model: ${model_name}
					                                                                        echo Task:  ${file_mark}
					                                                                        echo [CLI]
